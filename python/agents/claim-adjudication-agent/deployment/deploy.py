...
def main(argv: list[str]) -> None:
    ...
    bucket = FLAGS.bucket or os.getenv("AE_DEPLOYMENT_BUCKET") # Using the existing bucket from .env
    ...
    if FLAGS.list:
        ...
        print("Please specify an action: --create, --list, or --delete --resource_id=ID")
